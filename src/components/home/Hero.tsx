...
const Hero = () => {
  return (
    <div className="relative flex h-screen w-full flex-col bg-[url('/images/hero.png')] bg-cover bg-no-repeat min-h-screen">
      ...
      <div className="flex h-full flex-col items-center justify-center">
        ...
        <Link href="https://coinablepay.com/store/deans-list">
          <button className="startbutton group flex h-14 w-max items-center justify-center gap-x-2 rounded bg-white pl-8 pr-7 font-space text-lg font-medium text-black">
            Get Started
            <svg
